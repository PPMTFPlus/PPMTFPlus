# PPMTF+
This is a source code of PPMTF+ (Privacy-Preserving Multiple Tensor Factorization Plus), a location synthesizer for a location trace anonymization contest in the following paper. 
...
Full paper: https://arxiv.org/abs/2107.10407

PPMTF+ is mostly implemented with C++. Data preprocessing and evaluation are implemented with Python. This software is released under the MIT License.
